...
### The artifact contract (most important / most fragile part)
...
- Artifact → parent events: `artifact_ready`, `component_selected`, `walkthrough_step_changed`, `artifact_error`.
- Parent → artifact commands: `focus_component`, `go_to_step`, `start_walkthrough`, `pause_walkthrough`, `reset_camera`, `explode`, `collapse`, `toggle_labels`.
